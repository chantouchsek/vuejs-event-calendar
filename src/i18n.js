export default {
  ...
  kh: {
    dayNames: ["អាទិត្យ", "ចន័្ទ", "អង្គារ", "ពុធ", "ព្រហស្បតិ៏", "សុក្រ", "សៅរ៍"],
    monthNames: ["មការា", "កុម្ភ", "មីនា", "មេសា", "ឧសភា", "មិថុនា", "កក្តដា", "សីហា", "កញ្ញា", "តុលា", "វិឆ្ឆិកា", "ធ្នូ"],
    format: 'MM/yyyy',
    fullFormat: 'dd/MM/yyyy',
    dayEventsTitle: 'ព្រឹត្តិការណ៏ទាំងអស់។',
    notHaveEvents: 'ពុំមានព្រឹត្តិការណ៏នោះទេ។'
  },
  hu: {
